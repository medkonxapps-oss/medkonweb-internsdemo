...
export function AboutBiogra() {
  const experiences = [
    ...
    {
      year: "2017 - 2019",
      title: "Visualizer & Director",
      company: "Apple Software",
    },
  ...
  return (
    <section className="about-section py-0  relative overflow-hidden">
        ...
        <div className="about-content-wrap grid lg:grid-cols-3 gap-12">
          ...
          <div className="about-mid-content space-y-16">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                "I'm <span className="text-primary font-semibold">Medkon</span>{" "}
                a UI/UX designer passionate about creating intuitive,
                user-centered digital experiences. I help brands turn complex
            ...
            >
              ...
              <div className="about-exp-items space-y-6">
                {experiences.map((exp, index) => (
                  ...
                  >
                    <div className="mb-2">
                      <span className="year text-sm text-muted-foreground">
                        {exp.year}
                      </span>
                    </div>
            ...
            >
              ...
              <ul className="about-ed-list space-y-4">
                {education.map((edu, index) => (
                  ...
                  >
                    <span className="category font-semibold">
                      {edu.category}
                    </span>
          ...
          >
            <div className="about-author-info relative p-8 rounded-3xl bg-card/30 border border-border/50 backdrop-blur-sm">
              ...
              <h4 className="name text-2xl font-serif font-bold text-center mb-2">
                Medkon
              </h4>
              ...
              <ul className="about-ed-list space-y-4">
                <li className="flex justify-between items-center py-3 border-b border-border/30">
                  ...
                  <a
                    ...
                    className="category font-semibold hover:text-primary"
                  >
                    +1 (234) 567 8899
                  </a>
                </li>
